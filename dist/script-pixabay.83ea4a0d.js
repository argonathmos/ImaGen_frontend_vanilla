...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"script-pixabay.js":[function(require,module,exports) {
"use strict";
...
var randomImg = document.querySelector('.random-img');
var ladySay = document.querySelector('.lady-say'); // buttons
...
buttonsContainer.addEventListener('click', function (evt) {
  ...
  if (evt.target.nodeName === 'BUTTON') {
    ...
    var searchTerm = randomWord(evt.target.value.split(' ')); // console.log(endpoint);
...
var randomWord = function randomWord(array) {
  var word = array[Math.floor(Math.random() * array.length)];
  return word;
}; // Calls to the REST API


var getImage = function getImage(endpoint, searchTerm, endpointName) {
  _axios.default.get("https://imagen-rest-api.herokuapp.com/".concat(endpoint, "?q=").concat(searchTerm)).then(function (response) {
    // console.log(response.data);
    randomImg.setAttribute('src', response.data.src);
    setTimeout(function () {
      randomImg.style.display = 'block';
      ladySay.textContent = "".concat(endpointName, " says ").concat(searchTerm, " time!");
      ladySay.style.display = 'block';
    }, 500);
  }).catch(function (error) {
    console.log(error);
    randomImg.style.display = 'None';
    ladySay.textContent = "Sorry... ".concat(endpointName, " is in a bad mood today.");
    ladySay.style.display = 'block';
  });
};
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script-pixabay.js"], null)
//# sourceMappingURL=/script-pixabay.83ea4a0d.js.map